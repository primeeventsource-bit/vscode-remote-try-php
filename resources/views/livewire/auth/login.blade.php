<div class="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
    ...
    {{-- Left Logo — decorative, behind card, cannot block clicks --}}
    <div class="hidden lg:flex absolute left-0 top-0 bottom-0 items-center justify-center pointer-events-none z-0" style="width:45%;">
        <img src="{{ asset('images/prime-logo.png') }}" alt="" class="w-[500px] h-[500px] object-contain select-none" style="opacity:0.08;filter:blur(1.5px);" draggable="false">
    </div>

    {{-- Right Logo — decorative, behind card, cannot block clicks --}}
    <div class="hidden lg:flex absolute right-0 top-0 bottom-0 items-center justify-center pointer-events-none z-0" style="width:45%;">
        <img src="{{ asset('images/prime-logo.png') }}" alt="" class="w-[500px] h-[500px] object-contain select-none" style="opacity:0.08;filter:blur(1.5px);" draggable="false">
    </div>

    {{-- Login Card — main focus, above logos, fully clickable --}}
    <div class="relative z-10 w-full max-w-md mx-4">
        <div class="bg-white/95 backdrop-blur-sm border border-gray-200 rounded-2xl shadow-2xl p-10 text-center">
            ...
            <form wire:submit="authenticate" class="text-left space-y-4">
                ...
                <button type="submit"
                        class="relative z-20 w-full bg-gray-900 text-white rounded-xl py-3 text-sm font-semibold hover:bg-gray-800 active:scale-[0.98] transition-all mt-2 shadow-lg shadow-gray-900/20 cursor-pointer"
        ...
        {{-- Mobile: small faded logo below card --}}
        <div class="lg:hidden flex justify-center mt-8 pointer-events-none">
